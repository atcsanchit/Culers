...
export const LA_MASIA_SPOTLIGHTS: LaMasiaSpotlight[] = [
	...
	},
	{
		id: 'guardiola',
		name: 'Pep Guardiola',
		matchNames: ['pep guardiola', 'josep guardiola', 'guardiola'],
		position: 'Defensive midfielder',
		generation: 'La Masia · Dream Team',
		bio: 'The No. 4 who organised Cruyff’s midfield — then spent a lifetime teaching the rest of football to play like Barça.',
		debutNote: 'A Santpedor kid who made the pivot look like a pulpit.',
		status: 'alumni',
		photoUrl:
			'https://upload.wikimedia.org/wikipedia/commons/3/34/Pep-Guardiola-Barcelona-1992.jpg',
		barcaRecord: {
			years: '1990–2001',
			stats: [
				{ label: 'Apps', value: '384' },
				{ label: 'Goals', value: '11' },
				{ label: 'Assists', value: '40+' },
				{ label: 'Titles', value: '16' },
			],
			legacy: 'Dream Team metronome — six Ligas and a first European Cup as a player, before the treble as coach.',
		},
	},
	{
		id: 'valdes',
		name: 'Víctor Valdés',
		matchNames: ['victor valdes', 'víctor valdés', 'valdes', 'valdés'],
		position: 'Goalkeeper',
		generation: 'La Masia · Last line',
		bio: 'Sweeper-keeper before it was a slogan. Started with his feet, finished with five Zamoras and a treble.',
		debutNote: 'Owned the Camp Nou six-yard box for a decade.',
		status: 'alumni',
		photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/4/4d/V%C3%ADctor_Vald%C3%A9s_%282010%29.jpg',
		barcaRecord: {
			years: '2002–2014',
			stats: [
				{ label: 'Apps', value: '535' },
				{ label: 'Clean sheets', value: '240+' },
				{ label: 'Zamoras', value: '5' },
				{ label: 'Titles', value: '21' },
			],
			legacy: 'The academy keeper of the Guardiola years — three Champions Leagues without ever looking like a tourist.',
		},
	},
	{
		id: 'pique',
		name: 'Gerard Piqué',
		matchNames: ['gerard pique', 'gerard piqué', 'pique', 'piqué'],
		position: 'Centre-back',
		generation: 'La Masia · Returnee',
		bio: 'Left as a kid, came home as a champion. Built from the back, scored in Clásicos, never small in a big shirt.',
		debutNote: 'Bernabéu 2009 — a homecoming goal in a 2–6 that still rings.',
		status: 'alumni',
		photoUrl:
			'https://upload.wikimedia.org/wikipedia/commons/9/94/Real_Valladolid_-_FC_Barcelona%2C_2018-08-25_%2858%29.jpg',
		barcaRecord: {
			years: '2008–2022',
			stats: [
				{ label: 'Apps', value: '616' },
				{ label: 'Goals', value: '53' },
				{ label: 'Assists', value: '13' },
				{ label: 'Titles', value: '30' },
			],
			legacy: 'Second-spell centre-back who became a trophy machine — La Masia DNA with European steel.',
		},
	},
	{
		id: 'pedro',
		name: 'Pedro',
		matchNames: ['pedro', 'pedro rodriguez', 'pedro rodríguez'],
		position: 'Winger',
		generation: 'La Masia · Treble edge',
		bio: 'Both feet, both flanks, big-game goals. The winger who made Guardiola’s press look inevitable.',
		debutNote: 'Rome 2009 — a treble-season breakout that never cooled off.',
		status: 'alumni',
		photoUrl:
			'https://upload.wikimedia.org/wikipedia/commons/3/30/Bar%C3%A7a_-_Napoli_-_20140806_-_Pedro_Rodriguez_%28cropped%29.jpg',
		barcaRecord: {
			years: '2008–2015',
			stats: [
				{ label: 'Apps', value: '321' },
				{ label: 'Goals', value: '99' },
				{ label: 'Assists', value: '50+' },
				{ label: 'Titles', value: '20' },
			],
			legacy: 'First player to score in six different competitions in one season — academy winger, serial winner.',
		},
	},
	{
		id: 'alba',
		name: 'Jordi Alba',
		matchNames: ['jordi alba', 'alba'],
		position: 'Left-back',
		generation: 'La Masia · Overlap',
		bio: 'Hospitalet pace down the line, Messi on the end of it. Turned full-back into a second winger.',
		debutNote: 'Came home in 2012 and never stopped overlapping.',
		status: 'alumni',
		photoUrl:
			'https://upload.wikimedia.org/wikipedia/commons/d/dc/Real_Valladolid_-_FC_Barcelona%2C_2018-08-25_%2899%29.jpg',
		barcaRecord: {
			years: '2012–2023',
			stats: [
				{ label: 'Apps', value: '459' },
				{ label: 'Goals', value: '27' },
				{ label: 'Assists', value: '99' },
				{ label: 'Titles', value: '16' },
			],
			legacy: 'The left-flank highway of the MSN years — La Masia start, Valencia detour, Camp Nou encore.',
		},
	},
	{
		id: 'cesc',
		name: 'Cesc Fàbregas',
		matchNames: ['cesc', 'cesc fabregas', 'cesc fàbregas', 'fabregas'],
		position: 'Midfielder',
		generation: 'La Masia · False nine',
		bio: 'The kid who left for Arsenal and came back to unlock Pep’s midfield — assists, disguised nines, Clásico nerve.',
		debutNote: 'Homecoming in 2011: the pass before the pass.',
		status: 'alumni',
		photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Cesc_F%C3%A0bregas_-_Presentation.jpg/960px-Cesc_F%C3%A0bregas_-_Presentation.jpg',
		barcaRecord: {
			years: '2011–2014',
			stats: [
				{ label: 'Apps', value: '151' },
				{ label: 'Goals', value: '42' },
				{ label: 'Assists', value: '44' },
				{ label: 'Titles', value: '8' },
			],
			legacy: 'Short second act, heavy trophy cabinet — La Masia brain on a false-nine leash.',
		},
	},
	{
		id: 'amor',
		name: 'Guillermo Amor',
		matchNames: ['guillermo amor', 'amor'],
		position: 'Midfielder',
		generation: 'La Masia · Cruyff core',
		bio: 'Engine of the Dream Team. Won everything before Europe learned the academy’s name.',
		debutNote: 'The original academy midfielder who refused to be a cameo.',
		status: 'alumni',
		photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/52/Guillermo-Amor-Barcelona-1992.jpg',
		barcaRecord: {
			years: '1988–1998',
			stats: [
				{ label: 'Apps', value: '421' },
				{ label: 'Goals', value: '47' },
				{ label: 'Assists', value: '30+' },
				{ label: 'Titles', value: '10' },
			],
			legacy: 'Most decorated La Masia midfielder of the Cruyff era — five Ligas and Wembley ’92.',
		},
	},
	{
		id: 'roberto',
		name: 'Sergi Roberto',
		matchNames: ['sergi roberto', 'roberto'],
		position: 'Midfielder / right-back',
		generation: 'La Masia · Utility',
		bio: 'Wherever the shirt needed him. The Paris 6–1 assist still lives in the bloodstream.',
		debutNote: 'Debuted as a midfielder, became the emergency full-back who never looked emergency.',
		status: 'alumni',
		photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/9/98/Sergi_Roberto_2019_03_17_1.jpg',
		barcaRecord: {
			years: '2010–2024',
			stats: [
				{ label: 'Apps', value: '373' },
				{ label: 'Goals', value: '18' },
				{ label: 'Assists', value: '40+' },
				{ label: 'Titles', value: '12' },
			],
			legacy: 'Fourteen seasons, one club, every position behind the strikers — loyalty as a footballing skill.',
		},
	},
];
